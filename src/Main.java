...
public class Main {
        ...
        public static void main(String[] args) {
            ...
            while (true){
                ...
                while(JoueurPositions.contains(position)|| OrdinateurPositions.contains(position)){
                    System.out.println("Mauvaise Position choissiez une autre position");
                    position = sc.nextInt();
                }
        ...
        public  static String Verification_Qui_Gagne(){
            ...
            List<List> Gagneur = new ArrayList<List>();
            Gagneur.add(HAUT);
            Gagneur.add(MILIEU);
            Gagneur.add(DESSENT);
            Gagneur.add(Col_gauche);
            Gagneur.add(Col_milieu);
            Gagneur.add(Col_bas);
            Gagneur.add(Col_mil);
            Gagneur.add(col_droit);
            for (List i:Gagneur) {
